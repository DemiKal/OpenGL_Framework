	...
	const std::vector<float>& uvs) const
{
	...
	//glEnableVertexAttribArray(0);    // We like submitting m_Vertices on stream 0 for no special reason
	//glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 5 * sizeof(float), (const void*)0 );      // The starting point of the m_VBO, for the m_Vertices
